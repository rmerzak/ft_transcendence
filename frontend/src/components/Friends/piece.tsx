...
const Piece = ({ picture }: { picture: string }) => {
    return (
            <div className="relative text-whiterelative bg-achievements1 w-[26%] h-[150px]">
                ...
                <button><ThumbsUp size={16} strokeWidth={3}/></button>
                <button><ThumbsDown size={16} strokeWidth={3}/></button></div>
            </div>
    )
}
