                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <label htmlFor="code" className="hidden ">Code:</label>
                                    <input onChange={(e) => { setCode(e.target.value); }} type="text" id="code" placeholder="code" className="text-gray-500 w-[20.438rem] h-[2.75rem] pl-[1.063rem] leading-normal" />
                                    <LockKeyhole className=" absolute md:right-6 right-7" />
                                </div>
