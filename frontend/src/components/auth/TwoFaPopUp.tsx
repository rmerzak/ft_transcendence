...
const TwoFaPopUp = ({ open, onClose, image }: any) => {
    ...
    async function handleSubmit(event: any) {
        ...
        const response = await axios.post('http://localhost:3000/auth/2fa/verify',Data, {
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <form onSubmit={handleSubmit} >
                                ...
                                <div className="flex justify-between pt-3">
                                    ...
                                    <button type="submit" onClick={handleSubmit} data-modal-hide="popup-modal" className="text-white bg-[#79196F] hover:bg-[#a6419c] focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center ">
                                        Yes, Activate
                                    </button>
                                </div>
                            </form>
