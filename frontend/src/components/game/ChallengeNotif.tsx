                ...
                <div role="alert" className="alert bg-transparent shadow-2xl border-0 flex">
                    <div className="flex flex-col">
                        <div className="mb-8 rounded-2xl backdrop-blur-md bg-[#311150]/50 w-full">
                            <h1  className="text-center font-inter text-sm sm:text-xl p-4 text-[#ffffff]/80" >Challenge</h1>
                            <GameSwiper />
                        ...
                        <div className="justify-evenly flex">
                            <button className="btn w-32 h-10 font-inter text-white text-md bg-[#ffffff]/20" onClick={() => {openAl(); refuse()}}>refuse</button>
                            <button className="btn w-32 h-10 font-inter text-white text-md bg-[#811B77]/50" onClick={() => {openAl(); challenge();}}>Accept</button>
                        </div>
                    </div>
                </div>
            </OutsideClickHandler>
