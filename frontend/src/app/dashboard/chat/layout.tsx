...
const Layout = ({ children }: any) => {
  ...
  return (
    <div className="pb-4 w-full h-screen bg-[#311251]/80 md:rounded-3xl rounded-t-md md:w-[95%]  md:mt-6 md:overflow-auto md:mx-auto md:shadow-lg">
      <h1 className="text-white md:text-3xl text-lg md:font-bold text-center m-2 p-1 md:m-4 md:p-2 font-inter w-auto">
        Chat
      </h1>
      <div className="rounded-md mx-2 md:mx-6 flex justify-between items-center flex-wrap border">
